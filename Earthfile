...
ARG STYLUS_BASE=us-docker.pkg.dev/palette-images-dev/public/yogi/edge/stylus-framework-linux-amd64:v0.0.0-69469b97
ARG STYLUS_PACKAGE_BASE=us-docker.pkg.dev/palette-images-dev/public/yogi/edge/stylus-linux-amd64:v0.0.0-69469b97
...
stylus-image-pack:
    ...
    RUN luet util pack us-docker.pkg.dev/palette-images-dev/public/yogi/edge/stylus-framework-linux-amd64:v0.0.0-69469b97 stylus.tar stylus-image.tar
...
stylus-image:
    FROM --platform=linux/${ARCH} us-docker.pkg.dev/palette-images-dev/public/yogi/edge/stylus-framework-linux-amd64:v0.0.0-69469b97
...
stylus-package-image:
    FROM --platform=linux/${ARCH} us-docker.pkg.dev/palette-images-dev/public/yogi/edge/stylus-linux-amd64:v0.0.0-69469b97
    SAVE ARTIFACT --keep-ts --keep-own  ./*
