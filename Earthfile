...
>>>>>>> da91d45 (copy apparmor to /usr/bin and update provider/pe versions (#81))
...
<<<<<<< HEAD
ARG K3S_PROVIDER_VERSION=v4.1.0-alpha4
ARG KUBEADM_PROVIDER_VERSION=v4.1.0-alpha7
ARG RKE2_PROVIDER_VERSION=v4.1.0-alpha3
=======
