...
To build ARM images use the following command 

```shell
./earthly.sh +build-all-images --PE_VERSION=v4.0.x --BASE_IMAGE=quay.io/kairos/core-opensuse-leap-arm-generic:v2.2.1 --ARCH=arm64
```
