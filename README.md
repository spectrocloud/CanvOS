...
For ubuntu fips, the following image builtt from ubuntu-fips dockerfile can be used as the BASE_IMAGE gcr.io/spectro-images-public/ubuntu-focal-fips:v20230808
FIPS is not supported for `opensuse-leap` at the moment.
For rhel fips, base image needs to built by using the docker file in `rhel-fips`. Please follow the instructions in the dockerfile. 
...
| OS_DISTRIBUTION  | OS distribution of your choice. For example, it can be `ubuntu` or `opensuse-leap` or `rhel`                                                                                                                                                                                                                                                    | String | `ubuntu`                |
