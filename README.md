...
| platform             | Type of platform to use for the build.  Used for Cross Platform Build (arm64 to amd64 as example).  <br/>                                                                                                                                                                                                                                      | string | `linux/amd64`            | 
| UBUNTU_ONE_PRO_TOKEN | Ubuntu one pro token.      <br/>                                                                                                                                                                                                                                                                                                                     | string | ``                       |
| FIPS                 | To build FIPS compliant images, set the attribute to true  <br/>                                                                                                                                                                                                                                                                               | string | `false`                  |
