...
| INCLUDE_K8S_ALWAYS          | Bundle Kubernetes binaries and provider plugins into UKI and non-UKI provider images even when the base OS supports systemd extensions. This affects provider images only; installer images continue to use automatic systemd-extension detection.                                                                                             | boolean | `false`                    |
